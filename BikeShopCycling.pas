...
uses BikeShopAutoraize, BikeShopRegistration, AdminDataBase,
  ...
  BikeShopContacts, BikeShopCatalog, AboutTheProgram, BikeShopHome, Prepod,
  BikeShopTrek, BikeShopRoad, BikeShopEkippirovka;

{$R *.dfm}

procedure TForm39.FormCreate(Sender: TObject);
begin
Form39.DoubleBuffered:=true;
...
procedure TForm39.Image20Click(Sender: TObject);
begin
Form2.Close;
Form3.Close;
Form4.Close;
...
procedure TForm39.Timer2Timer(Sender: TObject);
begin
if Form7.label10.Caption='' then Image14.Visible:=false else Image14.Visible:=True;
end;

procedure TForm39.Image23Click(Sender: TObject);
begin
Form29.Show;
end;

procedure TForm39.Image22Click(Sender: TObject);
begin
Form30.ShowModal;
end;

procedure TForm39.Image1Click(Sender: TObject);
begin
Form2.Close;
Form3.Close;
Form4.Close;
...
procedure TForm39.SpeedButton12Click(Sender: TObject);
begin
...
procedure TForm39.SpeedButton14Click(Sender: TObject);
begin
Form8.Show;
end;

procedure TForm39.SpeedButton18Click(Sender: TObject);
begin
Form10.Show;
end;

procedure TForm39.Image8Click(Sender: TObject);
begin
begin
...
procedure TForm39.Image14Click(Sender: TObject);
begin
...
procedure TForm39.Image2Click(Sender: TObject);
begin
...
procedure TForm39.Image4MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
...
procedure TForm39.Image21Click(Sender: TObject);
begin
Form39.Close;
end;

procedure TForm39.Label3MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
Label3.Font.Size:=13;
Panel2.Visible:=True;
...
procedure TForm39.Label4MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
Label4.Font.Size:=13;
Panel3.Visible:=True;
...
procedure TForm39.Label5MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
Label5.Font.Size:=13;
Panel4.Visible:=True;
...
procedure TForm39.Label6MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
Label6.Font.Size:=13;
Panel4.Visible:=false;
...
procedure TForm39.Label7MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
Panel5.Visible:=True;
Label7.Font.Size:=13;
...
procedure TForm39.FormMouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
...
procedure TForm39.Image25MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
...
procedure TForm39.Image26MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
SpeedButton19.Font.Size:=12;
...
procedure TForm39.Image20MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
PNGButton1.Font.Size:=17;
end;

procedure TForm39.Image21MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
PNGButton2.Font.Size:=17;
end;

procedure TForm39.Image22MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
PNGButton3.Font.Size:=17;
end;

procedure TForm39.Image23MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
PNGButton4.Font.Size:=17;
end;

procedure TForm39.Image24MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
PNGButton5.Font.Size:=17;
end;

procedure TForm39.Image3MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
PNGButton1.Font.Size:=16;
PNGButton2.Font.Size:=16;
...
procedure TForm39.Label43Click(Sender: TObject);
begin
Form40.ShowModal;
end;

procedure TForm39.Image24Click(Sender: TObject);
begin
if image14.Visible=False
then
if Form1.Label1.Caption='POPULAR PRODUCTS'
...
procedure TForm39.Image28MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
...
procedure TForm39.Image44MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
...
procedure TForm39.Image48MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
...
procedure TForm39.Image32MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
...
procedure TForm39.Image36MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
...
procedure TForm39.Shape6MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
...
procedure TForm39.Shape10MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
...
procedure TForm39.Shape11MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
...
procedure TForm39.Shape7MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
...
procedure TForm39.Shape8MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
...
procedure TForm39.Shape5MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
...
procedure TForm39.Image16MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
...
procedure TForm39.Shape1MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
Image4.Visible:=True;
Image5.Visible:=False;
...
procedure TForm39.Label42Click(Sender: TObject);
begin
Form41.ShowModal;
end;
...
procedure TForm39.Image28Click(Sender: TObject);
begin
...
procedure TForm39.Image44Click(Sender: TObject);
begin
if Form7.Label16.Caption=''
 then
if Image8.Visible=true
...
procedure TForm39.Image48Click(Sender: TObject);
begin
if Form7.Label16.Caption=''
 then
if Image8.Visible=true
...
procedure TForm39.Image32Click(Sender: TObject);
begin
if Form7.Label16.Caption=''
 then
if Image8.Visible=true
...
procedure TForm39.Image36Click(Sender: TObject);
begin
if Form7.Label16.Caption=''
 then
if Image8.Visible=true
...
procedure TForm39.Image16Click(Sender: TObject);
begin
if Form7.Label16.Caption=''
 then
if Image8.Visible=true
...
procedure TForm39.SpeedButton20Click(Sender: TObject);
begin
Form39.Caption:='Магазин Велотоваров "VeloGo"/Велосипеды';
...
procedure TForm39.SpeedButton19Click(Sender: TObject);
begin
Form39.Caption:='Bike Shop "VeloGo"/Cycling';
...
procedure TForm39.Image25Click(Sender: TObject);
begin
SpeedButton19.Click;
end;

procedure TForm39.Image26Click(Sender: TObject);
begin
SpeedButton20.Click;
end;

procedure TForm39.SpeedButton8Click(Sender: TObject);
begin
...
procedure TForm39.SpeedButton9Click(Sender: TObject);
begin
...
procedure TForm39.SpeedButton10Click(Sender: TObject);
begin
SpeedButton8.Font.Color:=clGray;
SpeedButton9.Font.Color:=clGray;
SpeedButton10.Font.Color:=clBlack;
...
procedure TForm39.SpeedButton11Click(Sender: TObject);
begin
SpeedButton8.Font.Color:=clGray;
SpeedButton9.Font.Color:=clGray;
SpeedButton10.Font.Color:=clGray;
